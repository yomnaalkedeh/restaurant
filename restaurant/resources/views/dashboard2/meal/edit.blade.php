								...
								<div class="row">
                                    <div class="col-md-12">
										<div class="mb-3">
											...
											<select name="category_id" id="category_id" class="form-control">
                                                <option value="" disabled {{ old('category_id', $meal->category_id) ? '' : 'selected' }}>Select Category</option>
									...
									<div class="col-md-6">
										<div class="mb-3">
											...
											<input type="text" name="name" id="name" class="form-control" placeholder="Name" value="{{ $meal->name }}">
										</div>
									</div>
                                    <div class="col-md-6">
                                        <div class="mb-3">
                                            <label for="price">Price</label>
                                            <input type="text" name="price" id="price" class="form-control" placeholder="Price" value="{{ $meal->price }}">
                                        </div>
                                    </div>
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="description" id="description" cols="30" rows="10" class="summernote" placeholder="Description">{{ old('description', $meal->description) }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($meal->image)
                                                        <div class="mt-3">
                                                            ...
                                                            <img src="{{ asset($meal->image) }}" alt="Current Image" class="img-thumbnail" width="150">
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
