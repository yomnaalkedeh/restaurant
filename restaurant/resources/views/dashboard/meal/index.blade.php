    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <div class="dropdown-container" id="mealDropdown">
                ...
                <p>Image: <img src="{{ $meal->image }}" alt="{{ $meal->name }}" width="100"></p>
                @endforeach
            </div>
        </div>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <form method="GET" action="{{ route('meals.edit', $meal->id) }}">
                                @csrf

                                <button class="edit-button" type="submit" style=" border:none">Edit</button>
                            ...
                            <form action="{{ route('meals.destroy', $meal->id) }}" method="POST" style="display:inline-block;">
                                ...
                                @method('DELETE')
                                    ...
                                    <button class="delete-button"  type="submit" style="margin-top: -70px ; border:none">Delete</button>
